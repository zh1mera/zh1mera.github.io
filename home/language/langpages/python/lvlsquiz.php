...
<head>
    ...
    <title>Python Level <?php echo $level; ?> - BYTEMe</title>    <link rel="stylesheet" href="../../../../assets/css/style.css">
...
<body>
    ...
    <main class="challenge-container">        <div class="challenge-header">
            ...
            <div class="language-badge" style="background-color: #3572A5;">Python</div>
        </div>
