...
try {
    ...
    // Record the attempt
    $stmt = $pdo->prepare("INSERT INTO progress (user_id, language, difficulty, is_correct, created_at)
    ...
    echo json_encode([
        'success' => false, 
        'message' => '⚠️ An error occurred while processing your submission. Please try again.'
    ]);
}
?>
